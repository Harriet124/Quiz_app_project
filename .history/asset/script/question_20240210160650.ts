...
questionInfoContainer.appendChild(questionNumber);
questionInfoContainer.appendChild(questionText);
...
topContainer.appendChild(questionInfoContainer);
leftContainer.appendChild(topContainer);
leftContainer.appendChild(progressBarContainer);

// Now, leftContainer contains both the questionNumber and questionText in one container
// And progressBarContainer contains the progressBar
// Both are appended to topContainer and leftContainer respectively
