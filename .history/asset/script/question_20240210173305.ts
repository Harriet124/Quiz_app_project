    ...
    if (questionListContainer) {
      ...
      if (filteredData.length > 0) {
        ...
        function displayCurrentQuestion() {
          ...
          // Append progressContainer to leftContainerif
          leftContainer.append(questionNumber, questionText, progressContainer);

          if(progressContainer){ progressContainer = document.getElementById("progress-bar-container");
          }
...
// Now you can call the refreshPageSilently function whenever you want to refresh the page silently.
