...
// Append the score container inside the left container
const scoreContainer = document.querySelector(".score-parent-container");
const leftContainer = document.querySelector(".score-left-container");
questionListContainer.appendChild(scoreContainer);  
