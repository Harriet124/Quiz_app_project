...
// Create and append the 'completed' span
const completedSpan = document.createElement("span");
completedSpan.classList.add("completed");
completedSpan.textContent = "Quiz completed";
scoreLeftContainer.appendChild(completedSpan);

// Create and append the 'score' span
const scoreSpan = document.createElement("span");
scoreSpan.classList.add("score");
scoreSpan.textContent = "You Scored.. ";
scoreLeftContainer.appendChild(scoreSpan);
...
// Create and append the 'score-board' div
const scoreBoardDiv = document.createElement("div");
scoreBoardDiv.classList.add("score-board");

// Create and append the 'header' span
const headerSpan = document.createElement("span");
headerSpan.classList.add("header");

// Create and append the 'img' element
const imgElement = document.createElement("img");
imgElement.style.backgroundColor = filteredData[0].color;
imgElement.src = imageUrl;
headerSpan.appendChild(imgElement);

// Create and append the 'span' for 'typeParam'
const typeParamSpan = document.createElement("span");
typeParamSpan.textContent = typeParam;
headerSpan.appendChild(typeParamSpan);

// Append the 'header' span to the 'score-board' div
scoreBoardDiv.appendChild(headerSpan);

// Create and append the 'digit' span
const digitSpan = document.createElement("span");
digitSpan.classList.add("digit");
digitSpan.innerText = totalScore.toString();
scoreBoardDiv.appendChild(digitSpan);

// Create and append the 'p' for 'out'
const outP = document.createElement("p");
outP.classList.add("out");
outP.textContent = `out of ${filteredData[0].questions.length}`;
scoreBoardDiv.appendChild(outP);

// Append the 'score-board' div to the 'score-right-container'
scoreRightContainer.appendChild(scoreBoardDiv);

// Create and append the 'a' for the 'Play Again' button
const playAgainLink = document.createElement("a");
playAgainLink.href = "/";
playAgainLink.appendChild(document.createElement("button")).classList.add("againBtn");
playAgainLink.querySelector(".againBtn").textContent = "Play Again";
scoreRightContainer.appendChild(playAgainLink);
...
function toggleDarkModeStyles(mode: string) {
  ...
  body.style.backgroundImage =
    mode === "#f4f6fA"
      ...
      const scoreBoard = document.getElementsByClassName("score-board") as HTMLElement;
      scoreBoard.style.backgroundColor = mode === "#f4f6fA" ? "#3B4D66" : "#ffffff";
      scoreBoard.style.color = mode === "#f4f6fA" ? "#ffffff" : "#313e51";
